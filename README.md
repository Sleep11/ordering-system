...
所有 API 响应均包含 `code` 字段，可复制用于排查问题。
...
| AUTH-0001 | 未登录 |
| AUTH-0002 | 无权限 |
| AUTH-0003 | 用户名和密码不能为空 |
| AUTH-0004 | 用户名或密码错误 |
| AUTH-0005 | 登录尝试次数过多 |
| AUTH-0006 | 登录失败（服务器） |
| AUTH-0007 | 退出失败 |
| AUTH-0008 | 获取用户信息失败 |
| AUTH-0009 | 旧密码和新密码不能为空 |
| AUTH-0010 | 新密码长度不能少于6位 |
| AUTH-0011 | 旧密码错误 |
| AUTH-0012 | 修改密码失败 |
| AUTH-0013 | 请输入管理员密码 |
| AUTH-0014 | 密码错误 |
...
| USER-0009 | 用户ID不能为空 |
| USER-0010 | 不能删除自己的账号 |
| USER-0011 | 必须保留至少一个管理员 |
| USER-0012 | 删除用户失败 |
| USER-0013 | 密码已重置为123456 |
| USER-0014 | 重置密码失败 |
| USER-0015 | 用户数据读取失败 |
| USER-0016 | 重置用户数据失败 |
...
| ORDER-0000 | 操作成功 |
| ORDER-0001 | 获取订单失败 |
| ORDER-0002 | 日期和餐别不能为空 |
| ORDER-0003 | 餐别无效 |
| ORDER-0004 | 请选择餐品 |
| ORDER-0005 | 无权限删除此订单 |
| ORDER-0006 | 无权限为他人订餐 |
| ORDER-0007 | 无权限修改付款状态 |
| ORDER-0008 | 无权限退款 |
| ORDER-0009 | 价格无效 |
| ORDER-0010 | 自定义餐品名称不能为空 |
| ORDER-0011 | 餐食数据格式错误 |
| ORDER-0012 | 自定义餐品信息不完整 |
| ORDER-0013 | 午餐点餐已被管理员锁定 |
| ORDER-0014 | 晚餐点餐已被管理员锁定 |
| ORDER-0015 | 系统已锁定，不允许修改餐品 |
| ORDER-0016 | 系统已锁定，不允许删除餐品 |
| ORDER-0017 | 提交订单失败 |
| ORDER-0018 | 订单ID不能为空 |
| ORDER-0019 | 订单不存在 |
| ORDER-0020 | 删除订单失败 |
...
|---|---|
| SETTING-0000 | 操作成功 |
| SETTING-0001 | 设置key不能为空 |
| SETTING-0002 | 价格必须在0.5~200之间 |
| SETTING-0003 | 更新设置失败 |
...
- 文档：README 新增 API 错误码表（AUTH/USER/ORDER/MENU/SETTING/REPORT/SYS）
