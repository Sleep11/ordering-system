...
const routes = [
  {
    ...
    children: [
      ...
      { path: 'report', name: 'report', component: () => import('@/components/report/ReportPanel.vue') },
      { path: 'dish', name: 'dish', component: () => import('@/components/admin/DishManager.vue') },
      { path: 'admin', name: 'admin', component: () => import('@/components/admin/UserManager.vue') }
    ]
  }
]
